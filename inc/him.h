...
typedef struct _IDENTIFY_DATA {
	...
	HPT_U16 stream_transfer_time_pio;
	HPT_U16 reserved3;
	HPT_U16 physical_logical_sector_size;
	HPT_U16 delay_acoustic_testing;
	HPT_U16 naa;
	HPT_U16 unique_id1;
	HPT_U16 unique_id2;
	HPT_U16 unique_id3;
	HPT_U16 Reserved8[4];							/*	112-115	*/
	HPT_U16 Reserved9;								/*	116	*/
	HPT_U16 words_per_logical_sector[2];				/*	117-118	*/
	HPT_U16 Reserved10[8];
	HPT_U16 Removable_Media_Status_Notification;		/*	127	*/
	HPT_U16 Security_Status;							/*	128	*/
	HPT_U16 Vendor_Specific[31];						/*	129-159	*/
	HPT_U16 CFA_Power_Mode;							/*	160	*/
	HPT_U16 Reserved11[15];							/*	161-175	*/
	HPT_U16 Current_Media_Serial_Number[30];			/*	176-205	*/
	HPT_U16 Reserved12[3];							/*	206-208	*/
	HPT_U16 log_sec_off_within_first_phy;                     /* 209 */
	HPT_U16 Reserved13[45];							/*	210-254	*/
	HPT_U8  Signature;
	HPT_U8  checksum;
}
#ifdef __GNUC__
...
#define   RETURN_CHECK_CONDITION     18
