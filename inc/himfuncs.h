...
_HIM_INTERFACE(HPT_BOOL, check_pci_removed, (void *adapter))
_HIM_INTERFACE(void, handle_pci_removed, (void *adapter))
_HIM_INTERFACE(void, clear_static_var,(void))
...
_HIM_INTERFACE(void *, xor_init, (void* vbus, void *arg))
_HIM_INTERFACE(void, xor_add_item, (void *_task, BUS_ADDRESS dar, BUS_ADDRESS sar[], HPT_U32 nsrc, HPT_U32 bytecount))
_HIM_INTERFACE(void, xor_exec, (void* vbus, void *_task, void * done, void *tag))

_HIM_INTERFACE(void *, pq_init, (void* vbus, void *arg))
_HIM_INTERFACE(void, pq_add_item, (void *_task, BUS_ADDRESS dar, BUS_ADDRESS sar[], HPT_U8 *mr, HPT_U32 nsrc, HPT_U32 bytecount))
_HIM_INTERFACE(void, pq_add_item2, (void *_task, BUS_ADDRESS pq, BUS_ADDRESS pp, BUS_ADDRESS src[], HPT_U32 nsrc, HPT_U32 bytecount))
_HIM_INTERFACE(void, pq_exec, (void* vbus, void *_task, void * done, void *tag))
