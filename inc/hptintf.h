...
#define HPT_IOCTL_GET_DRIVER_CAPABILITIES_V3    HPT_CTL_CODE(76)
...
#define HPT_IOCTL_NOTIFY_SURPRISE_REMOVE    HPT_CTL_CODE(300)
/************************************************************************
...
#define CHIP_SUPPORT_SPINUP   0x10
...
#define HPT_CAP_RECOVER  0x20
#define HPT_CAP_USB_TARGET  0x20  /* USB Target conflict with Recover, only happened on Mac OS  */
#define HPT_CAP_RECOVER_EXT  0x40
...
#define CEXF_V2_EXT_LOADER 1
#define CEXF_V2_EXT_BIOS 2
...
int hpt_get_driver_capabilities_v3(int id, PDRIVER_CAPABILITIES_V2 cap);
