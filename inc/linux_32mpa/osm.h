/*
 * $Id: osm.h,v 1.8 2010/05/11 10:28:20 lcn Exp $
 ...
 *if Max devices>8, use 16MB internal R5 cache.
 *if Max devices<=8, use 8MB internal R5 cache.
 */
...
HPT_U8   os_readb  (void *osext, void *addr);
HPT_U16  os_readw  (void *osext, void *addr);
HPT_U32  os_readl  (void *osext, void *addr);
void     os_writeb (void *osext, void *addr, HPT_U8 value);
void     os_writew (void *osext, void *addr, HPT_U16 value);
void     os_writel (void *osext, void *addr, HPT_U32 value);
...
#define diag_printf /*os_printknt */
