...
HPT_U8   os_readb  (void *osext, void *addr) { return readb(addr); }
HPT_U16  os_readw  (void *osext, void *addr) { return readw(addr); }
HPT_U32  os_readl  (void *osext, void *addr) { return readl(addr); }
void     os_writeb (void *osext, void *addr, HPT_U8 value)  { writeb(value, addr); }
void     os_writew (void *osext, void *addr, HPT_U16 value) { writew(value, addr); }
void     os_writel (void *osext, void *addr, HPT_U32 value) { writel(value, addr); }
